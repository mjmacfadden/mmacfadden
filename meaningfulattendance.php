<?php 
$page_title = "Mike Macfadden - Meaningful Attendance";
...
$og_title = "Mike Macfadden - Meaningful Attendance";
...
<div class="page_header">
  <div class="container py-4">
    <div class="row py-4">
      <!-- First Row -->
      <div class="col">
        <h1>Meaningful Attendance</h1>
      </div>
    </div>
  </div>
</div>

<div class="container py-4 meaningful_attendance">
    <div class="row py-4">
      <div class="col">
