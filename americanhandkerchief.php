<?php 
$page_title = "Mike Macfadden - American Handkerchief";
...
$og_title = "Mike Macfadden - American Handkerchief";
...
<div class="page_header">
  <div class="container py-4">
    <div class="row py-4">
      <!-- First Row -->
      <div class="col">
        <h1>American Handkerchief</h1>
      </div>
    </div>
  </div>
</div>

<div class="container py-4 american_handkerchief">
    <div class="row py-4">
      <div class="col">
