...
<div class="container py-4">
  <div class="row py-4">
    <div class="col-md-8">
      ...
      <ul>
        <li>Host various projects.</li>
        <li>Link out to all of the other place I live online.</li>
        <li>Experiment with graphic design, code, and fool around with technology.</li>
      </ul>
      ...
      <a href="https://www.amazon.com/s?i=digital-text&rh=p_27%3AMichael+Macfadden&s=relevancerank&text=Michael+Macfadden&ref=dp_byline_sr_ebooks_1" target="_blank">
        <img src="img/some_friends.webp" class="img-fluid mx-auto d-block" style="width:100%; max-width:450px;" alt="Some Friends - Children's Stories" />
      </a>
